...
public class ATM {
	...
	public boolean getMoney(int sum) {
		if (sum % 20 != 0 && sum % 50 != 0) {
			System.out.println("The ammount of mone should be 20 fold");
			return false;
		}
		...
		if (sum > sumInt) {
			System.out.println("ATM does not have " + sum
		...
		if (sum > 0) {
			System.out
					.println("Try another sum, the give sum could not be reached");

			return false;
		}

		if (s100 != 0) {
			System.out.println(s100 + " of 100 y.e. were given to you");
		}

		if (s50 != 0) {
			System.out.println(s50 + " of 50 y.e. were given to you");
		}

		if (s20 != 0) {
			System.out.println(s20 + " of 20 y.e. were given to you");
		}
